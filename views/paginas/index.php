        ...
        <?php foreach ($ponentes as $ponente) { ?>
            <div <?php aos_animacion();?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" src="<?php echo $_ENV["HOST"] . "/img/speakers/" . $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
...
<section class="boletos">
    ...
    <div  class="boletos__grid">
        ...
        <div class="boleto__enlace-contenedor">
            <a <?php aos_animacion();?> href="/paquetes" class="boleto__enlace">Ver Paquetes</a>
        </div>
    </div>
</section>