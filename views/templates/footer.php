<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <h1 class="footer__logo">&#60;DevWebCamp/></h1>

            <p class="footer__texto">DevWebCamp es una conferencia para desarolladores de todos los niveles, se lleva a cambo de forma presencial y en linea</p>
