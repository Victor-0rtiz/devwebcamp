    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                ...
                <img class="evento__imagen-autor" src="<?php echo $_ENV["HOST"] . "/img/speakers/" . $evento->ponente->imagen; ?>.png" alt="Imagen Ponente">
            </picture>
        ...
        <?php echo ($evento->disponibles === "0")? "Agotados" : "Agregar - ". $evento->disponibles . " Disponibles"; ?>
        </button>
    </div>
</div>